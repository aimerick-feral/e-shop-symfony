...
{
    public function __construct(private PurchaseRepository $purchaseRepository, private PurchaseAddress $purchaseAddress, private EntityManagerInterface $entityManagerInterface)
    {
    }
