...
class PurchaseController extends AbstractController
{
    ...
    public function purchase(Request $request, DeliveryModeRepository $deliveryModeRepository, UrlGeneratorInterface $urlGeneratorInterface): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $purchase
                ...
                // We set the status of the purchase with the value of the PHP constant STATUS_PENDING_CHECKOUT because the payment has not yet been made and therefore the purchase is not yet confirmed. 
    ...
    public function detail(string $reference): Response
    {
        ...
        return $this->render(
            ...
            [
                'purchase' => $purchase,
                // // Brut data extract from databse.
                // 'billingAddress' => $purchase->getBillingAddress(),
                // // Data after nl2br() or str_replace().
    ...
    public function stripeSuccess(Request $request, Email $email): Response
    {
        ...
        // We set the purchase status with the value of the PHP constant STATUS_PAID because the checkout is confirm. 
