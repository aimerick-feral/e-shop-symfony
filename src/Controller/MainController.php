...
class MainController extends AbstractController
{
    ...
    /**
     * Method that display the terms_of_use page. 
     * @return Response
     */
    #[Route('/conditions-generales-d-utilisation', name: 'terms_of_use', methods: 'GET')]
    public function termsOfUse(): Response
    {
        // We display our template. 
        return $this->render(
            'main/terms-of-use.html.twig',
            // We set a array of optional data.
            [],
            // We specify the related HTTP response status code.
            new Response('', 200)
    ...
    /**
     * Method that display the terms_of_sales page. 
     * @return Response
     */
    #[Route('/conditions-generales-de-vente', name: 'terms_of_sales', methods: 'GET')]
    public function termsOfSales(): Response
    {
        // We display our template. 
        return $this->render(
            'main/terms-of-sales.html.twig',
            // We set a array of optional data.
            [],
            // We specify the related HTTP response status code.
            new Response('', 200)
