        ...
        $builder
            ...
            ->add('deliveryMode', EntityType::class, [
                ...
                'choice_attr' => function (DeliveryMode $deliveryMode, $key, $index) {
                    return [
                        'class' => 'form-field__input-purchase-delivery-mode',
            ...
            ->add('checkoutMethod', ChoiceType::class, [
                ...
                'choice_attr' => [
                    Purchase::CHECKOUT_METHOD_CREDIT_CARD => [
                        'class' => 'form-field__input-purchase-checkout-method form-field__stripe-input',
                        'data-value' => Purchase::CHECKOUT_METHOD_CREDIT_CARD

                    ],
                    Purchase::CHECKOUT_METHOD_PAYPAL => [
                        'class' => 'form-field__input-purchase-checkout-method form-field__paypal-input',
