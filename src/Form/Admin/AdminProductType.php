    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('availability', ChoiceType::class, [
                ...
                'choice_attr' => [
                    Product::AVAILABLE => [
                        'class' => 'form-field__input-product-availability form-field__input-product-availability-available',
                    ],
                    Product::UNAVAILABLE => [
                        'class' => 'form-field__input-product-availability form-field__input-product-availability-unavailable',
                    ],
                ],
                'expanded' => true
            ])
            ->add('category', EntityType::class, [
                ...
                'choice_attr' => function (Category $category, $key, $index) {
                    return ['class' => 'form-field__input-product-category'];
                },
                'expanded'      => true,
            ]);
    }
