            ...
            ->add('civilityTitle', ChoiceType::class, [
                ...
                'choice_attr' => [
                    User::MAN_CIVILITY_TITLE => [
                        'class' => 'form-field__input-user-civility-title form-field__input-user-civility-title-man form-field__input-user-civility-title-profile',
                    ],
                    User::WOMAN_CIVILITY_TITLE => [
                        'class' => 'form-field__input-user-civility-title form-field__input-user-civility-title-woman form-field__input-user-civility-title-profile',
                    ],
                ],
                'expanded' => true,
                'disabled'  => true,
