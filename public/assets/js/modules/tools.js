const tools = {
  ...
  /**
   * Method that remove the display-none CSS class from one or several elements in order to display it.
   * @param {Array} element
   * @return {void}
   */
  ...
  /**
   * Method that toggle the display-none CSS class to one or several elements in order to display it.
   * @param {Array} element
   * @return {void}
   */
  ...
  toggleClassToElements: function (className, ...elements) {
    ...
    // For each element of elements.
    for (let element of elements) {
      // We use the classList API in order to toggle className to element.
